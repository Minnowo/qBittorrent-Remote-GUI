...
class MagnetLinkDialog(QW.QDialog):
    def __init__(self, parent=None):
        ...
        self.text_edit.setPlaceholderText("Put magnet links here, 1 per line.")
        ...
        self.dropdown_management_mode.currentIndexChanged.connect(self._torrent_management_mode_changed)
